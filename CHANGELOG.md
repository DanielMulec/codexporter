...
- Updated `AGENTS.md` so history-sensitive reimplementations or supersessions must carry explicit commit-message traceability footers, and any pull request that lands such work must repeat the same links and state whether the older branch was merged, superseded, or selectively salvaged.
