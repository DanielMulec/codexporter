...
| US-02 | As a Codex user, I want repeated exports in the same session to contain only new content so that I do not get duplicate exports. | Must | v1 | J-02, J-04 | F-02 |  |  |  |
...
| US-04 | As a Codex user, I want the export to fail clearly in my current conversation language when it cannot complete. | Must | v1 | J-03 | F-03 |  |  |  |
| US-05 | As a Codex user, I want the export filename sequence to stay clear across multiple exports of the same session. | Must | v1 | J-02, J-04 | F-02 |  |  |  |
