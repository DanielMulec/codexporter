...
- `export_sequence`
- `last_exported_event_timestamp` or other stable cursor field
...
- `last_exported_event_timestamp` or stable cursor: marks how far the successful export progressed
- `last_exported_turn_id`: optional extra anchor when session structure exposes it reliably
