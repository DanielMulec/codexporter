...
- the product questions that still need decisions
...
The initial user stories now live in `docs/spec/02_user_stories.md`.

The triage document remains focused on product scope, priorities, assumptions, and open decisions.
