...
- The compact checklist item is now backed by Daniel's broader April 2-3, 2026 live CLI retest across full and compact export orders, one retained April 3, 2026 live `$export --compact` CLI transcript, and the maintained macOS-host automated full-flow and compaction tests.
