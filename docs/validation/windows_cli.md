...
- Validation dates: March 20, March 27, and April 3, 2026
...
- The compact checklist item is now backed by Daniel's April 3, 2026 live Windows CLI retest across full and compact export orders plus the fresh Windows-host automated full-flow and compaction tests.
